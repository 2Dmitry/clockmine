...
2. Clockify-API предоставляет информацию о времени начала запуска таймера и о времени окончания, на основе этих двух данных можно строить временные интервалы, которые бы показывали, когда работали, а когда делали перерывы
3. AsyncIO
4. Отформатировать report-таблицу, сейчас слишком громоздко
